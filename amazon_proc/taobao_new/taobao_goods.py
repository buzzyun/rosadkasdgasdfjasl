...
def doTestProc(browser, db_con, db_ali, db_price, in_pgKbn, in_ver, goods_dic, asin_low): #goods_dic, db_con, db_ali, asin_low, connect_mode):
    ...
    # asin get
    # get_asin_list2 = []
    # get_asin_list2 = taobao_func.get_update_goods("", db_FS, db_con)
    ...
    # goods test 
    rtnChk = taobao_func.proc_asin_parse_brower(goods_dic, db_con, db_ali, browser, pgName, "taobao", db_price)
...
if __name__ == '__main__':
    ...
    if str(currIp).strip() == "222.104.189.18":
        ...
        taobao_func.version_check_2(db_con, ver, pgFilename, input_pgKbn)
    ...
    now_url = "https://world.taobao.com/"
    browser.get(now_url)
    ...
    while roofCnt < 50000:
        ...
        if input_pgKbn == "test":
            ...
            rtnFlg = doTestProc(browser, db_con, db_ali, db_price, input_pgKbn, ver, goods_dic, asin_list)
