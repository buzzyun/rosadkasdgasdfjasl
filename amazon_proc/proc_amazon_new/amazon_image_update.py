...
if __name__ == '__main__':
    ...
    sel_db = input("Site Input:")
    if sel_db == "":
        print(">> No site ")
    else:
        print(">> selDB : {}".format(sel_db))
        db_am = DBmodule_AM.Database(str(sel_db))
        rcnt = 0
        ### test
        ### sql = "select goodscode, naver_img, imgb, naver_in, other_img1, other_img2, other_img3, other_img4, other_img5, c.Content, g.uid from t_goods as g inner join T_GOODS_CONTENT as c on c.uid = g.uid  where stop_update is null and IsDisplay = 'T' and UpdateDate is null and g.regdate >= '2023-02-01 00:00:00' and g.regdate < '2023-03-01 00:00:00' and goodscode = 'Q0032273349' "
        #sql = "select goodscode, naver_img, imgb, naver_in, other_img1, other_img2, other_img3, other_img4, other_img5, c.Content, g.uid from t_goods as g inner join T_GOODS_CONTENT as c on c.uid = g.uid  where stop_update is null and IsDisplay = 'T' and isnull(g.UpdateDate,g.regdate) >= '2023-10-01 00:00:00' and isnull(g.UpdateDate,g.regdate) < '2024-01-09 00:00:00' and imgb like 'https://m.media-amazon.com/images/W/%' and imgb not like 'https://m.media-amazon.com/images/W/MEDIAX_' "
