...
sql_day = "select top 1 procdate from freeship_overlap_img_work where procdate <> '" + str(toDay) + "' and state='F' order by procDate desc"
...
site = str(sys.argv[1]).strip() # 사이트 입력
