...
def proc_order(browser, dic_order):
    ...
    dic_order['m_choice'] = ""
    if str(result_org).find('businessModel') > -1:
        choice_tmp = func_ali.getparse(str(result_org),'businessModel',',')
...
#                 'cookie': 'intl_loc
    ...
    try:
        mainDriver = func_ali.connectDriverOld('https://ko.aliexpress.com/',"")
        print(">> connectDriverOld OK ")
    except Exception as e:
        mainDriver = func_ali.connectDriverNew('https://ko.aliexpress.com/',"")
